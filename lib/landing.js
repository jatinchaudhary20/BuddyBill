...
export const TESTIMONIALS = [
  {
    quote:
      "what a great app! Now I can keep track of all my shared expenses without the hassle of manual calculations.",
  ...
  {
    quote:
      "BuddyBill has transformed how I manage expenses with friends. It's so easy to use and keeps everything transparent.",
  ...
  {
    quote:
      "If you're looking for a reliable way to split expenses, BuddyBill is the answer. Highly recommended!",
    name: "Job Searcher",
